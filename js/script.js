...
var book_images = ["images/internment.jpg", "images/fever-code.jpg", "images/wildcard.jpg", "images/all-the-light.jpg", "images/return-del-king.jpg"];
...
function changeBook() {
  if (document.getElementById("top-5").innerHTML == top1) {
    ...
    document.getElementById("top-5-image").src = book_images[0];
    ...
    for (var i=0; i < 4; i++) {
      if (document.getElementById("top-5").innerHTML == all_top_5[i]) {
        ...
        document.getElementById("top-5-image").src = book_images[i+1];
...
function rotate() {
  for (var i=0; i < images.length; i++) {
    if (document.getElementById("animation").src == images[images.length - 1]) {
      document.getElementById("animation").src = images[0];
      break;
    }
    else if (document.getElementById("animation").src == images[i]) {
    document.getElementById("animation").src = images[i+1];
    break;
    }
  }
}
