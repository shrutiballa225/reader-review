...
var images = ["images/internment.jpg", "images/fever-code.jpg", "images/wildcard.jpg", "images/all-the-light.jpg", "images/return-del-king.jpg"];
...
function changeBook() {
  if (document.getElementById("top-5").innerHTML == top1) {
    ...
    document.getElementById("top-5-image").src = images[0];
    ...
    for (var i=0; i < 4; i++) {
      if (document.getElementById("top-5").innerHTML == all_top_5[i]) {
        ...
        document.getElementById("top-5-image").src = images[i+1];
